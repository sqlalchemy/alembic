...
def visit_add_column(element: AddColumn, compiler: PGDDLCompiler, **kw) -> str:
    return "%s %s" % (
        ...
        add_column(
            compiler,
            element.column,
            postgresql_if_not_exists=element.postgresql_if_not_exists,
            **kw,
        ),
    )
...
def visit_drop_column(
    ...
    return "%s %s" % (
        ...
        drop_column(
            compiler,
            element.column.name,
            postgresql_if_exists=element.postgresql_if_exists,
            **kw,
        ),
    )
