...
# these tests exercise naming convention rendering for CHECK
# constraints, so they name the opt-in plugin explicitly
_ck_plugin_enabled = [
...
class AutogenerateNamingConvTest(NamingConvModel, AutogenTest, TestBase):
    __only_on__ = "sqlite"
    configure_opts = {"autogenerate_plugins": _ck_plugin_enabled}
...
class AutogenerateNamingConvWBatchTest(NamingConvModel, AutogenTest, TestBase):
    ...
    configure_opts = {
        ...
        "render_as_batch": True,
        "autogenerate_plugins": _ck_plugin_enabled,
    }
